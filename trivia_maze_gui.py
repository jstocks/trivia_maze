...
class TriviaGUI(Canvas):
    ...
    def __init__(self, dimension, master=None, gameboard=None, sound=True):
        ...
        self.canvas = Canvas(self, width=dimension,
                             height=dimension,
                             bg="lightskyblue1")
        self.canvas.pack()
        self.show_board()
    ...
    def new(self):
        ...
        mbox = messagebox.askquestion('Start a new game?',
                                      icon='warning')
        if mbox == 'yes':
    ...
    def load(self):
        ...
        if not os.path.isfile("saved_game"):
            ...
            return
        mbox = messagebox.askquestion('Load saved game?',
                                      icon='warning')
        if mbox == 'yes':
            ...
            self.show_board()
            self.show_cell()
            messagebox.showinfo(title='Game Loaded',
    ...
    def save(self):
        ...
        """
        mbox = messagebox.askquestion('Save game?',
                                      icon='warning')
        if mbox == 'yes':
            game = self.board
    ...
    def help(self):
        ...
        intro = "Find your way to Mars by answering questions " \
                ...
                "you to continue along your journey. " \
                "Wrong answers require you to seek an alternate orbit.  " \
                "If you find yourself without a path to Mars, " \
                "you will run out of oxygen and meet your ultimate " \
                "demise...\n\n " \
    ...
    def about(self):
        """
        Displays information about the game creators
        and course.
        """
        messagebox.showinfo(title='Directions',
                            message="Rocket Man Trivia Game\n\n"
                                    "Created by Sriba Rajendran & "
                                    "Jeff Stockman\n\n"
                                    "University of Washington Graduate "
                                    "Certificate Program for Software "
                                    "Development Engineering\n\n"
                                    "Core requirement for TCSS504 - "
                                    "March 2021 ")
    ...
    def quit(self):
        ...
        self.sound_quit()
        mbox = messagebox.askquestion('Exit... Are you sure?',
                                      icon='warning')
        if mbox == 'yes':
            self.master.destroy()
        else:
    ...
    def menu_widgets(self):
        ...
        """
        self.bnew = Button(self, text="NEW", height=1,
                           width=5, bg="gold",
                           fg="black", relief="raised",
                           command=self.new)
        self.bnew.place(x=4, y=4)
        self.bload = Button(self, text="LOAD", height=1,
                            width=5, bg="gold",
                            fg="black", relief="raised",
                            command=self.load)
        self.bload.place(x=49, y=4)
        self.bsave = Button(self, text="SAVE", height=1,
                            width=5, bg="gold",
                            fg="black", relief="raised",
                            command=self.save)
        self.bsave.place(x=94, y=4)
        self.bhelp = Button(self, text="HELP", height=1,
                            width=5, bg="gold",
                            fg="black", relief="raised",
                            command=self.help)
        self.bhelp.place(x=139, y=4)
        self.bexit = Button(self, text="EXIT", height=1,
                            width=5, bg="gold",
                            fg="black", relief="raised",
                            command=self.quit)
        self.bexit.place(x=184, y=4)
        self.bhidden = Button(self, text=" ", height=1,
                              width=2, bg="lightskyblue1",
                              fg="lightskyblue1", relief="flat",
                              command=self.sound_hidden)
    ...
    def move_widgets(self):
        ...
        self.move_up = Button(self, text="MOVE UP", height=1,
                              width=10, bg="gold",
                              fg="black", relief="raised",
                              state=NORMAL, command=self.plan_to_move_up)
        self.move_up.place(x=585, y=140)
        self.move_down = Button(self, text="MOVE DOWN", height=1,
                                width=10, bg="gold",
                                fg="black", relief="raised", state=NORMAL,
                                command=self.plan_to_move_down)
        self.move_down.place(x=585, y=340)
        self.move_left = Button(self, text="MOVE\nLEFT", height=2,
                                width=6, bg="gold",
                                fg="black", relief="raised", state=NORMAL,
                                command=self.plan_to_move_left)
        self.move_left.place(x=490, y=230)
        self.move_right = Button(self, text="MOVE\nRIGHT", height=2,
                                 width=6, bg="gold",
                                 fg="black", relief="raised", state=NORMAL,
                                 command=self.plan_to_move_right)
    ...
    def legend(self):
        ...
        """
        label = Label(self.canvas, text='LEGEND', fg='black',
                      bg='lightskyblue1', font="bold")
        ...
        label = Label(self.canvas, text='Player Token', fg='black',
                      bg='lightskyblue1', font="bold")
        ...
        label2 = Label(self.canvas, text='Available Paths', fg='black',
                       bg='lightskyblue1', font="bold")
        ...
        label3 = Label(self.canvas, text='Blocked Paths', fg='black',
                       bg='lightskyblue1', font="bold")
        ...
        label4 = Label(self.canvas, text='Finish', fg='black',
                       bg='lightskyblue1', font="bold")
    ...
    def question(self):
        ...
        """
        # question box
        label = Label(self.canvas, text='QUESTION', fg='black',
                      bg='lightskyblue1', font="bold")
        self.canvas.create_window(550, 490, window=label)

        self.canvas.create_rectangle(360, 525, 750, 750,
                                     fill='lightskyblue1')

    def show_board(self):
        """
        Displays the game board, player token, and
        available paths / blocked paths.
        """
        ...
        # Row 1
        cell_1 = self.canvas.create_rectangle(x1, y1, x2, y2,
                                              fill='ivory2',
                                              outline="")
        path_1_2 = self.canvas.create_rectangle(x2, y1, x3, y2,
                                                fill='lightskyblue1',
                                                outline="")
        cell_2 = self.canvas.create_rectangle(x3, y1, x4, y2,
                                              fill='ivory2',
                                              outline="")
        path_2_3 = self.canvas.create_rectangle(x4, y1, x5, y2,
                                                fill='lightskyblue1',
                                                outline="")
        cell_3 = self.canvas.create_rectangle(x5, y1, x6, y2,
                                              fill='ivory2',
                                              outline="")
        path_3_4 = self.canvas.create_rectangle(x6, y1, x7, y2,
                                                fill='lightskyblue1',
                                                outline="")
        cell_4 = self.canvas.create_rectangle(x7, y1, x8, y2,
                                              fill='ivory2',
                                              outline="")

        # # Row 2
        path_1_5 = self.canvas.create_rectangle(x1, y2, x2, y3,
                                                fill='lightskyblue1',
                                                outline="")
        empty_1 = self.canvas.create_rectangle(x2, y2, x3, y3,
                                               fill='lightskyblue1',
                                               outline="")
        path_2__6 = self.canvas.create_rectangle(x3, y2, x4, y3,
                                                 fill='lightskyblue1',
                                                 outline="")
        empty_2 = self.canvas.create_rectangle(x4, y2, x5, y3,
                                               fill='lightskyblue1',
                                               outline="")
        path_3_7 = self.canvas.create_rectangle(x5, y2, x6, y3,
                                                fill='lightskyblue1',
                                                outline="")
        empty_3 = self.canvas.create_rectangle(x6, y2, x7, y3,
                                               fill='lightskyblue1',
                                               outline="")
        path_4_8 = self.canvas.create_rectangle(x7, y2, x8, y3,
                                                fill='lightskyblue1',
                                                outline="")

        # Row 3
        cell_5 = self.canvas.create_rectangle(x1, y3, x2, y4,
                                              fill='ivory2',
                                              outline="")
        path_5_6 = self.canvas.create_rectangle(x2, y3, x3, y4,
                                                fill='lightskyblue1',
                                                outline="")
        cell_6 = self.canvas.create_rectangle(x3, y3, x4, y4,
                                              fill='ivory2',
                                              outline="")
        path_6_7 = self.canvas.create_rectangle(x4, y3, x5, y4,
                                                fill='lightskyblue1',
                                                outline="")
        cell_7 = self.canvas.create_rectangle(x5, y3, x6, y4,
                                              fill='ivory2',
                                              outline="")
        path_7_8 = self.canvas.create_rectangle(x6, y3, x7, y4,
                                                fill='lightskyblue1',
                                                outline="")
        cell_8 = self.canvas.create_rectangle(x7, y3, x8, y4,
                                              fill='ivory2',
                                              outline="")

        # Row 4
        path_5_9 = self.canvas.create_rectangle(x1, y4, x2, y5,
                                                fill='lightskyblue1',
                                                outline="")
        empty_4 = self.canvas.create_rectangle(x2, y4, x3, y5,
                                               fill='lightskyblue1',
                                               outline="")
        path_6_10 = self.canvas.create_rectangle(x3, y4, x4, y5,
                                                 fill='lightskyblue1',
                                                 outline="")
        empty_5 = self.canvas.create_rectangle(x4, y4, x5, y5,
                                               fill='lightskyblue1',
                                               outline="")
        path_7_11 = self.canvas.create_rectangle(x5, y4, x6, y5,
                                                 fill='lightskyblue1',
                                                 outline="")
        empty_6 = self.canvas.create_rectangle(x6, y4, x7, y5,
                                               fill='lightskyblue1',
                                               outline="")
        path_8_12 = self.canvas.create_rectangle(x7, y4, x8, y5,
                                                 fill='lightskyblue1',
                                                 outline="")

        # Row 5
        cell_9 = self.canvas.create_rectangle(x1, y5, x2, y6,
                                              fill='ivory2',
                                              outline="")
        path_9_10 = self.canvas.create_rectangle(x2, y5, x3, y6,
                                                 fill='lightskyblue1',
                                                 outline="")
        cell_10 = self.canvas.create_rectangle(x3, y5, x4, y6,
                                               fill='ivory2',
                                               outline="")
        path_10_11 = self.canvas.create_rectangle(x4, y5, x5, y6,
                                                  fill='lightskyblue1',
                                                  outline="")
        cell_11 = self.canvas.create_rectangle(x5, y5, x6, y6,
                                               fill='ivory2',
                                               outline="")
        path_11_12 = self.canvas.create_rectangle(x6, y5, x7, y6,
                                                  fill='lightskyblue1',
                                                  outline="")
        cell_12 = self.canvas.create_rectangle(x7, y5, x8, y6,
                                               fill='ivory2',
                                               outline="")

        # # Row 6
        path_9_13 = self.canvas.create_rectangle(x1, y6, x2, y7,
                                                 fill='lightskyblue1',
                                                 outline="")
        empty_7 = self.canvas.create_rectangle(x2, y6, x3, y7,
                                               fill='lightskyblue1',
                                               outline="")
        path_10_14 = self.canvas.create_rectangle(x3, y6, x4, y7,
                                                  fill='lightskyblue1',
                                                  outline="")
        empty_8 = self.canvas.create_rectangle(x4, y6, x5, y7,
                                               fill='lightskyblue1',
                                               outline="")
        path_11_15 = self.canvas.create_rectangle(x5, y6, x6, y7,
                                                  fill='lightskyblue1',
                                                  outline="")
        empty_9 = self.canvas.create_rectangle(x6, y6, x7, y7,
                                               fill='lightskyblue1',
                                               outline="")
        path_12_16 = self.canvas.create_rectangle(x7, y6, x8, y7,
                                                  fill='lightskyblue1',
                                                  outline="")

        # Row 7
        cell_13 = self.canvas.create_rectangle(x1, y7, x2, y8,
                                               fill='ivory2',
                                               outline="")
        path_13_14 = self.canvas.create_rectangle(x2, y7, y8, y8,
                                                  fill='lightskyblue1',
                                                  outline="")
        cell_14 = self.canvas.create_rectangle(x3, y7, x4, y8,
                                               fill='ivory2',
                                               outline="")
        path_14_15 = self.canvas.create_rectangle(x4, y7, x5, y8,
                                                  fill='lightskyblue1',
                                                  outline="")
        cell_15 = self.canvas.create_rectangle(x5, y7, x6, y8,
                                               fill='ivory2',
                                               outline="")
        path_15_16 = self.canvas.create_rectangle(x6, y7, x7, y8,
                                                  fill='lightskyblue1',
                                                  outline="")
        cell_16 = self.canvas.create_rectangle(x7, y7, x8, y8,
                                               fill='ivory2',
                                               outline="")
        ...
        self.canvas.create_image(100 + x * 100, 100 + y * 100,
                                 image=self.img6)
            ...
            for b in range(0, self.board.get_ny(), 2):
                if a - 1 >= 0:
                    if self.board.cell_at(a, b).has_west_path():
                        self.canvas.create_image(50 + a * 100, 100 + b * 100,
                                                 image=self.paths_horizontal)
                    else:
                        self.canvas.create_image(50 + a * 100, 100 + b * 100,
                                                 image=self.paths_blocked)
                if a + 1 <= self.board.get_nx() - 1:
                    if self.board.cell_at(a, b).has_east_path():
                        self.canvas.create_image(150 + a * 100, 100 + b * 100,
                                                 image=self.paths_horizontal)
                    else:
                        self.canvas.create_image(150 + a * 100, 100 + b * 100,
                                                 image=self.paths_blocked)
                if b + 1 <= self.board.get_ny() - 1:
                    if self.board.cell_at(a, b).has_south_path():
                        self.canvas.create_image(100 + a * 100, 150 + b * 100,
                                                 image=self.paths_vertical)
                    else:
                        self.canvas.create_image(100 + a * 100, 150 + b * 100,
                                                 image=self.paths_blocked)
                if b - 1 >= 0:
                    if self.board.cell_at(a, b).has_north_path():
                        self.canvas.create_image(100 + a * 100, 50 + b * 100,
                                                 image=self.paths_vertical)
                    else:
                        self.canvas.create_image(100 + a * 100, 50 + b * 100,
                                                 image=self.paths_blocked)
    ...
    def show_cell(self):
        ...
        """
        label = Label(self.canvas, text='CURRENT LOCATION',
                      fg='black', bg='lightskyblue1', font="bold")
        ...
        self.paths_blocked2 = ImageTk.\
            PhotoImage(file="blocked.png")
        a, b = self.board.current_cell()

        # Row 1
        n = self.canvas.\
            create_rectangle(x2, y1, x3, y2,
                             fill='lightskyblue1', outline="")
        if b - 1 >= 0:
            if self.board.cell_at(a, b).has_north_path():
                self.canvas.create_image((x2 + x3) / 2, (y1 + y2) / 2,
                                         image=self.paths_vertical)
            else:
                self.canvas.create_image((x2 + x3) / 2, (y1 + y2) / 2,
                                         image=self.paths_blocked)
        ...
        # self.canvas.create_image((x2 + x3) / 2, (y1 + y2) / 2,
        #                           image=self.paths_blocked2)

        # Row 2
        w = self.canvas.create_rectangle(x1, y2, x2, y3,
                                         fill='lightskyblue1',
                                         outline="")
        if a - 1 >= 0:
            if self.board.cell_at(a, b).has_west_path():
                self.canvas.create_image((x1 + x2) / 2, (y2 + y3) / 2,
                                         image=self.paths_horizontal)
            else:
                self.canvas.create_image((x1 + x2) / 2, (y2 + y3) / 2,
                                         image=self.paths_blocked)

        center = self.canvas.create_rectangle(x2, y2, x3, y3,
                                              fill='ivory2',
                                              outline="")
        self.img_token = ImageTk.PhotoImage(file="player_token.png")
        self.canvas.create_image((x2 + x3) / 2, (y2 + y3) / 2,
                                 image=self.img_token)

        e = self.canvas.create_rectangle(x3, y2, x4, y3,
                                         fill='lightskyblue1',
                                         outline="")
        if a + 1 <= self.board.get_nx() - 1:
            if self.board.cell_at(a, b).has_east_path():
                self.canvas.create_image((x3 + x4) / 2, (y3 + y2) / 2,
                                         image=self.paths_horizontal)
            else:
                self.canvas.create_image((x3 + x4) / 2, (y3 + y2) / 2,
                                         image=self.paths_blocked)
        ...
        # Row 3
        s = self.canvas.create_rectangle(x2, y3, x3, y4,
                                         fill='lightskyblue1',
                                         outline="")
        if b + 1 <= self.board.get_ny() - 1:
            if self.board.cell_at(a, b).has_south_path():
                self.canvas.create_image((x2 + x3) / 2, (y3 + y4) / 2,
                                         image=self.paths_vertical)
            else:
                self.canvas.create_image((x2 + x3) / 2, (y3 + y4) / 2,
                                         image=self.paths_blocked)
    ...
    def plan_to_move_up(self):
        """
        Helper move function that stores movement
        until after question is answered.
        """
        self.sound_click()
        self.moving_to = 1
        x, y = self.board.current_cell()
        cell = self.board.cell_at(x, y)
        if self.board.is_valid_cell(x, y - 1) is True \
    ...
    def plan_to_move_left(self):
        ...
        x, y = self.board.current_cell()
        cell = self.board.cell_at(x, y)
        if self.board.is_valid_cell(x - 1, y) is True \
    ...
    def prompt_question(self, __game_board):
        """
        Initializes the question status list of
        the gameboard depending on the number of questions
        in the database. Based on the random question type
        picked instantiates the Question class
    ...
    def show_question(self):
        """
        Displays the question and gets user input - answer.
        Calls the verify answer method
        ...
        if question.__class__.__name__ == "MultipleChoiceQuestion":
            label1 = Label(self.canvas, text=q[0], fg='black',
                           bg='lightskyblue1',
                           font="bold", wraplength=375,
                           justify="left")
            ...
            r1 = Radiobutton(self.canvas, text=q[1][0],
                             padx=20, fg='black', bg='lightskyblue1',
                             font="bold", variable=var,
                             value=q[1][0], command=get_ans)
            r1.place(x=400, y=620)
            r2 = Radiobutton(self.canvas, text=q[1][1], padx=20,
                             fg='black', bg='lightskyblue1',
                             font="bold", variable=var,
                             value=q[1][1], command=get_ans)
            r2.place(x=400, y=650)
            r3 = Radiobutton(self.canvas, text=q[1][2], padx=20,
                             fg='black', bg='lightskyblue1',
                             font="bold", variable=var,
                             value=q[1][2], command=get_ans)
            r3.place(x=400, y=680)
            r4 = Radiobutton(self.canvas, text=q[1][3], padx=20,
                             fg='black', bg='lightskyblue1',
                             font="bold", variable=var,
                             value=q[1][3], command=get_ans)
            ...
            r2 = Radiobutton(self.canvas, text=q[1][1],
                             padx=20, fg='black', bg='lightskyblue1',
                             font="bold", variable=var,
                             value=q[1][1], command=get_ans)
            ...
            label1 = Label(self.canvas, text=q, fg='black',
                           bg='lightskyblue1',
                           font="bold",
                           wraplength=375,
                           justify="center")
        ...
        if answer is True:
            ...
            if self.moving_to == 1:  # up
                self.board.cell_at(x, y).\
                    remove_path(self.board.cell_at(x, y - 1), "N")
            elif self.moving_to == 2:  # down
                self.board.cell_at(x, y).\
                    remove_path(self.board.cell_at(x, y + 1), "S")
            elif self.moving_to == 3:  # left
                self.board.cell_at(x, y).\
                    remove_path(self.board.cell_at(x - 1, y), "W")
            elif self.moving_to == 4:  # right
                self.board.cell_at(x, y).\
                    remove_path(self.board.cell_at(x + 1, y), "E")
    ...
    def now_move_up(self):
        """
        Method to move player to correct position
    ...
    def winning(self):
        ...
        if self.board.cell_at(x, y).get_exit() is True:
            self.sound_win()
            mbox1 = messagebox.\
                askquestion(title='You made it to Mars!',
    ...
    def losing(self):
        """Checks to see if all paths are blocked
        / can't traverse board.
        """
        x, y = self.board.current_cell()
